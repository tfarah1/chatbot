...
def initialize_session_state():
    ...
    st.session_state.setdefault('generated', ["Hi! How can I assist you today?"])
    st.session_state.setdefault('past', ["Hey there!"])
...
def display_chat_history():
    ...
    with container:
        with st.form(key='my_form', clear_on_submit=True):
            user_input = st.text_input("You:", placeholder="Ask anything about Generative AI...", key='input')
